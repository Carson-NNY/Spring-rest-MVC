...
class BeerOrderControllerTestIT {
  ...
  void testUpdateOrder() throws Exception {
    ...
    mockMvc.perform(put(BeerOrderController.BEER_ORDER_PATH_ID, beerOrder.getId())
            ...
            .content(objectMapper.writeValueAsString(beerOrderUpdateDTO)) //writeValueAsString() method serializes the beerOrderUpdateDTO object into a JSON string that can be sent in the body of an HTTP request.
            .with(BeerControllerTest.JWT_REQUEST_POST_PROCESSOR))
