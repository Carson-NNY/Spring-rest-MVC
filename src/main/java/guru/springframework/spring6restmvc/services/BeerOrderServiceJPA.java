...
public class BeerOrderServiceJPA implements BeerOrderService {
  ...
  public Optional<BeerOrderDTO> getBeerOrderById(UUID beerOrderId) {
    return Optional.ofNullable(beerOrderMapper.beerOrderToBeerOrderDto(beerOrderRepository
  ...
  @Override
  public void deleteById(UUID beerOrderId) {
  ...
  @Override
  public Optional<BeerOrderDTO> patchBeerOrderById(UUID beerOrderId, BeerOrderDTO beerOrderDTO) {
